...
path_A = [pwd '\Re-Ordered Data\'];

% save in MatLab data files
save([path_A '\activity.mat'], 'A');
save([path_A '\activity_sd.mat'], 'sd_A');
save([path_A '\activity_cor.mat'], 'Cor_A');
save([path_A '\m.mat'], 'm');

% save in Exel files
xlswrite([path_A '\activity'], A);
xlswrite([path_A '\activity_sd'], sd_A);
xlswrite([path_A '\activity_cor'], Cor_A);
xlswrite([path_A '\m'], m);

sprintf('Data was ordered successfully and has been saved in folder:\n\t%s',path_A)

% =========================================================================
set(handles.activity,'BackgroundColor','red');
set(handles.activity_sd,'BackgroundColor','red');
set(handles.activity_cor,'BackgroundColor','red');
set(handles.prior_order,'BackgroundColor','red');
% =========================================================================
